...
const DayCard = ({ day, focus, id, records, setRecords }) => {
  ...
  return (
    <>
      <div>
        <div className=" mt-6  mx-w-[850px] flex bg-white w-auto sm:w-full sm:h-20 h-auto   rounded-lg bg-opacity-20 backdrop-filter backdrop-blur-lg border-0 border-black drop-shadow-2xl">
          ...
          <div className="p-6 flex w-auto sm:w-[754px] sm:justify-between  lg:justify-between ">
